...
export const PROJECT_LOCATION_CATALOG: ProjectLocationCatalogEntry[] = [
  ...
  {
    key: "avant-scene",
    displayName: "Avant-Scène",
    aliases: ["Avant-Scène", "Avant-Scene"],
    references: ["AVANTSCENE"],
    shortReferences: [],
    countryCode: "CH",
    countryName: "Switzerland",
    cantonCode: "NE",
    ...
    postalCode: "2000",
    normalizedAddress: "2000 Neuchâtel",
    latitude: 47.021,
    longitude: 6.948,
    precision: "locality",
    confidence: "high",
    ...
    confirmation: "user",
    sourceUrl:
      "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Neuch%C3%A2tel&type=locations&origins=gg25",
    sources: [
      {
        url: "user-confirmed",
        kind: "user_confirmed",
        note: "Operator-confirmed: Neuchâtel, canton of Neuchâtel, Switzerland. Exact CRM name/reference only. Not inferred from the project name.",
      },
      {
        url: "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Neuch%C3%A2tel&type=locations&origins=gg25",
        kind: "municipal_mapping",
        note: "Official commune centroid for Neuchâtel (NE), PLZ 2000, rounded to 3 dp.",
      },
    ],
    notes:
      "User-confirmed municipality Neuchâtel, canton Neuchâtel. Matches only the Avant-Scène / AVANTSCENE CRM row. Street not recorded.",
  },
  {
    key: "bc-kingston",
    displayName: "BC Kingston",
    aliases: ["BC Kingston"],
    references: ["BC_KINGSTON"],
    shortReferences: [],
    countryCode: "JM",
    countryName: "Jamaica",
    cantonCode: null,
    ...
    municipality: "Kingston",
    postalCode: null,
    normalizedAddress: "Kingston, Jamaica",
    latitude: null,
    longitude: null,
    precision: "locality",
    confidence: "high",
    ...
    sources: [
      {
        url: "user-confirmed",
        kind: "user_confirmed",
        note: "Operator-confirmed: Kingston, Jamaica. Exact CRM name/reference only. Distinct from Grosvenor Vistas, K2, and a bare Kingston signal.",
      },
    ],
    notes:
      "User-confirmed Kingston, Jamaica. No postal district or coordinates invented. Does not apply to other Kingston-named projects.",
  },
  {
    key: "cressy",
    displayName: "Cressy",
    ...
    confirmation: "user",
    sourceUrl:
      "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Confignon&type=locations&origins=gg25",
    sources: [
      {
        url: "user-confirmed",
        kind: "user_confirmed",
        note: "Operator-confirmed: Confignon, canton of Geneva, Switzerland. Exact CRM name/reference only. Not inferred from the intercommunal Cressy quartier.",
      },
      {
        url: "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Confignon&type=locations&origins=gg25",
        kind: "municipal_mapping",
        note: "Confignon commune centroid from official Swiss commune geometry (gg25), PLZ 1232, rounded to 3 dp.",
      },
    ],
    notes:
      "User-confirmed municipality Confignon for the CRM project named Cressy / CRESSY only. Does not apply to Cressier or other Cressy-named rows. Street not recorded.",
  },
  {
    key: "floreal",
    displayName: "Floréal",
    aliases: ["Floréal", "Floreal"],
    references: ["FLOREAL"],
    shortReferences: [],
    countryCode: "CH",
    countryName: "Switzerland",
    ...
    postalCode: "1024",
    normalizedAddress: "1024 Ecublens",
    latitude: 46.529,
    longitude: 6.557,
    precision: "locality",
    confidence: "high",
    ...
    confirmation: "user",
    sourceUrl:
      "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Ecublens&type=locations&origins=gg25",
    sources: [
      {
        url: "user-confirmed",
        kind: "user_confirmed",
        note: "Operator-confirmed: Ecublens, canton of Vaud, Switzerland. Exact CRM name/reference only. Distinct from Ormet.",
      },
      {
        url: "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Ecublens&type=locations&origins=gg25",
        kind: "municipal_mapping",
        note: "Official commune centroid for Ecublens (VD), PLZ 1024, rounded to 3 dp.",
      },
    ],
    notes:
      "User-confirmed municipality Ecublens, canton Vaud. Matches only Floréal / FLOREAL. Does not overwrite Ormet or other Ecublens projects.",
  },
  {
    key: "campanules",
    displayName: "Campanules",
    aliases: ["Campanules"],
    references: ["CAMPANULES"],
    shortReferences: [],
    countryCode: "CH",
    countryName: "Switzerland",
    cantonCode: "VD",
    ...
    postalCode: "1124",
    normalizedAddress: "1124 Gollion",
    latitude: 46.587,
    longitude: 6.51,
    precision: "locality",
    confidence: "high",
    ...
    confirmation: "user",
    sourceUrl:
      "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Gollion&type=locations&origins=gg25",
    sources: [
      {
        url: "user-confirmed",
        kind: "user_confirmed",
        note: "Operator-confirmed: Gollion, canton of Vaud, Switzerland. Exact CRM name/reference only.",
      },
      {
        url: "https://api3.geo.admin.ch/rest/services/api/SearchServer?searchText=Gollion&type=locations&origins=gg25",
        kind: "municipal_mapping",
        note: "Official commune centroid for Gollion (VD), PLZ 1124, rounded to 3 dp.",
      },
    ],
    notes:
      "User-confirmed municipality Gollion, canton Vaud. Matches only Campanules / CAMPANULES. Street not recorded.",
  },
  {
    key: "defne",
    displayName: "Defne",
