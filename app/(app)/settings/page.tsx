...
export default function SettingsPage() {
  return (
    <PageContainer>
      ...
      <SectionAnchor id="workspace" title="Workspace">
        <Card>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <Info label="Workspace name" value="Geneva Office" />
            <Info label="Slug" value="geneva" />
      ...
      <div className="mt-10 rounded-xl border border-dashed border-[var(--color-line-strong)] bg-white p-5 flex items-start gap-3">
        <span className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-[var(--color-muted)] text-[var(--color-ink-muted)]">
          <IconExternalLink size={15} />
        </span>
        <div className="flex-1">
          <p className="text-[13.5px] font-semibold text-[var(--color-ink)]">
            Integrations
            <Badge tone="muted" size="sm" className="ml-2">Coming in V2</Badge>
          </p>
          <p className="text-[12.5px] text-[var(--color-ink-muted)] mt-0.5">
            Email providers, calendar sync, MLS sync and webhooks will live here.
          </p>
        </div>
      </div>
    </PageContainer>
