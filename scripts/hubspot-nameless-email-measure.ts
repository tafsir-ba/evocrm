...
async function main(): Promise<void> {
  ...
  const report = {
    ...
    rule: "email_bearing_missing_name_reclassification_v2",
    bucketCounts: {
    ...
    buckets,
    notes:
      "Exclusive email-bearing buckets under v2 policy: no invented names; missing_name never excludes when valid email present. still_to_migrate is the write cohort. Never routes ambiguity to General.",
  };
