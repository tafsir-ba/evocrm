...
export const DEFAULT_DICTIONARY_SEEDS: DefaultDictionarySeed[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "hubspot", label: "HubSpot", color: "#FF7A59", order: 1 },
      { key: "google_ads", label: "Google Ads", color: "#4285F4", order: 2 },
      { key: "meta_ads", label: "Meta Ads", color: "#1877F2", order: 3 },
      { key: "portal", label: "Portal", color: "#8B5CF6", order: 4 },
      { key: "referral", label: "Referral", color: "#10B981", order: 5 },
      { key: "broker", label: "Broker", color: "#F59E0B", order: 6 },
      { key: "manual", label: "Manual", color: "#6B7280", order: 7 },
    ],
  },
  {
    type: "property_type",
