...
export const createPropertyInputSchema = z
  .object({
    ...
    totalSurface: z.number().min(0).optional(),
    balconyTerraceSurface: z.number().min(0).optional(),
...
export const updatePropertyInputSchema = z
  .object({
    ...
    totalSurface: z.number().min(0).nullable().optional(),
    balconyTerraceSurface: z.number().min(0).nullable().optional(),
    surfaceUnit: surfaceUnitSchema.optional(),
